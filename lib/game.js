...
class Game {
    constructor(stage) {
        ...
        this.soundOnButton.y = 450;
        this.soundOnButton.scaleX = .75
        this.soundOnButton.scaleY = .75
        this.soundOffButton.x = 350;
        this.soundOffButton.y = 450;
        this.soundOffButton.scaleX = .75
        this.soundOffButton.scaleY = .75
        this.soundOnButton.addEventListener('click',()=>this.toggleSound(stage));
        this.soundOffButton.addEventListener('click',()=>this.toggleSound(stage));
    ...
    initialScreen(stage) {
        ...
        stage.addChild(intro, this.volButton, this.soundOnButton);
        canvas.onclick = () => {
