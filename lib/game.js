...
class Game {
    ...
    prePlayInfo() {
        ...
        this.stage.addChild(info, start, this.soundOnButton);
    ...
    startGame(){
        ...
        this.tickTimer();
        createjs.Ticker.addEventListener('tick', wrapCheck);
        createjs.Ticker.addEventListener('tick', collisionCheck);
    ...
    createScoreboard() {
        ...
        score.y = canvas.height - 70;
        this.stage.addChild(score);
    }

    updateScore() {
        this.stage.removeChild(this.score);
        const scoreText = new createjs.Text(`${this.scoreVal}`, "bold 60px Arial", "#FFFFFF");
